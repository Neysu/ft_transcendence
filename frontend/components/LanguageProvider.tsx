...
const translations = {
  en: {
    ...
    vs: "VS",
    validate: "Validate",
    botFailedCreateGame: "Failed to create bot game",
    botFailedPlayRound: "Failed to play round",
    botNotBotGame: "This is not a bot game",
    gameNotFound: "Game not found",
    gameAlreadyFinished: "Game already finished",
    gameMoveAlreadySubmitted: "Move already submitted",
    gameWsInvalidToken: "Invalid auth token",
    gameWsMessageTooLarge: "Message too large",
    gameWsInvalidJson: "Invalid JSON",
    gameWsNotRegistered: "Not registered",
    gameInvalidRoomCode: "Invalid room code",
    gameRoomCodeLength: "Room code must be 3-15 characters",
    gameRoomAlreadyExists: "Room already exists",
    gameRoomAlreadyCreated: "You already created a room",
    gameAlreadyHostingRoom: "You are already hosting this room",
    gameHostNotConnected: "Host is not connected",
    gameInvalidOpponentId: "Invalid opponent id",
    gameCannotPlayYourself: "Cannot play against yourself",
    gameOpponentNotFound: "Opponent not found",
    gameInvalidGameId: "Invalid game id",
    gameNotPlayer: "You are not a player in this game",
    gameNoRoundFound: "No round found",
    gameInvalidMove: "Invalid move",
    gameInvalidRoundMoves: "Invalid round moves",
    gameFailedCreate: "Failed to create game",
    gameFailedApplyMove: "Failed to apply move",
    gameUnknownMessageType: "Unknown message type",
    notFoundTitle: "Page Not Found",
    notFoundDescription: "The page you are looking for does not exist.",
    notFoundGoHome: "Go Home",
    notFoundImageAlt: "404",
    gameSummaryTitle: "Game Summary",
    gameSummaryNoData: "No game summary available",
    gameSummaryWinner: "Winner",
    gameSummaryWinnerYou: "You",
    gameSummaryWinnerOpponent: "Opponent",
    gameSummaryWinnerDraw: "Draw",
    gameSummaryFinalScore: "Final score",
    gameSummaryRound: "Round",
    gameSummaryPlayerMove: "Your move",
    gameSummaryOpponentMove: "Opponent move",
    gameSummaryOutcome: "Outcome",
    gameSummaryPointsDelta: "Points won/lost",
    gameSummaryScoreAfter: "Score after round",
    gameSummaryOutcomeWin: "Win",
    gameSummaryOutcomeLose: "Lose",
    gameSummaryOutcomeDraw: "Draw",
  },
  fr: {
    ...
    vs: "VS",
    validate: "Valider",
    botFailedCreateGame: "Impossible de creer la partie contre le bot",
    botFailedPlayRound: "Impossible de jouer ce round",
    botNotBotGame: "Ce n'est pas une partie contre le bot",
    gameNotFound: "Partie introuvable",
    gameAlreadyFinished: "Partie deja terminee",
    gameMoveAlreadySubmitted: "Coup deja envoye",
    gameWsInvalidToken: "Jeton d'authentification invalide",
    gameWsMessageTooLarge: "Message trop volumineux",
    gameWsInvalidJson: "JSON invalide",
    gameWsNotRegistered: "Utilisateur non enregistre",
    gameInvalidRoomCode: "Code de salle invalide",
    gameRoomCodeLength: "Le code de salle doit contenir entre 3 et 15 caracteres",
    gameRoomAlreadyExists: "La salle existe deja",
    gameRoomAlreadyCreated: "Vous avez deja cree une salle",
    gameAlreadyHostingRoom: "Vous hebergez deja cette salle",
    gameHostNotConnected: "L'hote n'est pas connecte",
    gameInvalidOpponentId: "Identifiant adverse invalide",
    gameCannotPlayYourself: "Vous ne pouvez pas jouer contre vous-meme",
    gameOpponentNotFound: "Adversaire introuvable",
    gameInvalidGameId: "Identifiant de partie invalide",
    gameNotPlayer: "Vous ne faites pas partie de cette partie",
    gameNoRoundFound: "Aucun round trouve",
    gameInvalidMove: "Coup invalide",
    gameInvalidRoundMoves: "Coups de round invalides",
    gameFailedCreate: "Impossible de creer la partie",
    gameFailedApplyMove: "Impossible d'appliquer le coup",
    gameUnknownMessageType: "Type de message inconnu",
    notFoundTitle: "Page introuvable",
    notFoundDescription: "La page que vous recherchez n'existe pas.",
    notFoundGoHome: "Retour a l'accueil",
    notFoundImageAlt: "404",
    gameSummaryTitle: "Resume de la partie",
    gameSummaryNoData: "Aucun resume de partie disponible",
    gameSummaryWinner: "Vainqueur",
    gameSummaryWinnerYou: "Vous",
    gameSummaryWinnerOpponent: "Adversaire",
    gameSummaryWinnerDraw: "Egalite",
    gameSummaryFinalScore: "Score final",
    gameSummaryRound: "Round",
    gameSummaryPlayerMove: "Votre coup",
    gameSummaryOpponentMove: "Coup adverse",
    gameSummaryOutcome: "Resultat",
    gameSummaryPointsDelta: "Points gagnes/perdus",
    gameSummaryScoreAfter: "Score apres le round",
    gameSummaryOutcomeWin: "Victoire",
    gameSummaryOutcomeLose: "Defaite",
    gameSummaryOutcomeDraw: "Egalite",
  },
  es: {
    ...
    vs: "VS",
    validate: "Validar",
    botFailedCreateGame: "No se pudo crear la partida contra el bot",
    botFailedPlayRound: "No se pudo jugar esta ronda",
    botNotBotGame: "Esta no es una partida contra el bot",
    gameNotFound: "Partida no encontrada",
    gameAlreadyFinished: "La partida ya termino",
    gameMoveAlreadySubmitted: "Movimiento ya enviado",
    gameWsInvalidToken: "Token de autenticacion invalido",
    gameWsMessageTooLarge: "Mensaje demasiado grande",
    gameWsInvalidJson: "JSON invalido",
    gameWsNotRegistered: "No registrado",
    gameInvalidRoomCode: "Codigo de sala invalido",
    gameRoomCodeLength: "El codigo de sala debe tener entre 3 y 15 caracteres",
    gameRoomAlreadyExists: "La sala ya existe",
    gameRoomAlreadyCreated: "Ya creaste una sala",
    gameAlreadyHostingRoom: "Ya estas hospedando esta sala",
    gameHostNotConnected: "El anfitrion no esta conectado",
    gameInvalidOpponentId: "Id de oponente invalido",
    gameCannotPlayYourself: "No puedes jugar contra ti mismo",
    gameOpponentNotFound: "Oponente no encontrado",
    gameInvalidGameId: "Id de partida invalido",
    gameNotPlayer: "No eres jugador en esta partida",
    gameNoRoundFound: "No se encontro ninguna ronda",
    gameInvalidMove: "Movimiento invalido",
    gameInvalidRoundMoves: "Movimientos de ronda invalidos",
    gameFailedCreate: "No se pudo crear la partida",
    gameFailedApplyMove: "No se pudo aplicar el movimiento",
    gameUnknownMessageType: "Tipo de mensaje desconocido",
    notFoundTitle: "Pagina no encontrada",
    notFoundDescription: "La pagina que buscas no existe.",
    notFoundGoHome: "Ir al inicio",
    notFoundImageAlt: "404",
    gameSummaryTitle: "Resumen de la partida",
    gameSummaryNoData: "No hay resumen de partida disponible",
    gameSummaryWinner: "Ganador",
    gameSummaryWinnerYou: "Tu",
    gameSummaryWinnerOpponent: "Oponente",
    gameSummaryWinnerDraw: "Empate",
    gameSummaryFinalScore: "Marcador final",
    gameSummaryRound: "Ronda",
    gameSummaryPlayerMove: "Tu movimiento",
    gameSummaryOpponentMove: "Movimiento rival",
    gameSummaryOutcome: "Resultado",
    gameSummaryPointsDelta: "Puntos ganados/perdidos",
    gameSummaryScoreAfter: "Marcador tras la ronda",
    gameSummaryOutcomeWin: "Victoria",
    gameSummaryOutcomeLose: "Derrota",
    gameSummaryOutcomeDraw: "Empate",
  },
};
